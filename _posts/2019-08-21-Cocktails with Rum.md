...
<img src="https://static.cuisineaz.com/240x192/i87761-cocktail-banana-dream.png" width="400"/>
...
graph TB
    ...
    shaker --> |2.fill| glass
    decor --> |3. decorate| glass

```

<img src="https://static.essen-und-trinken.de/bilder/1a/e1/21346/galleryimage/277d98801c0bbaaffcf3a240fa7090b3.jpg" width="400"/>
...
graph TB
    subgraph 1. fill
        A1(mint leaves) --> glass
        juice --> glass
        syrup --> glass
    end

    subgraph 2. muddle
        glass --> |muddle|A3(glass)
    end
